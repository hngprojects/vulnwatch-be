...
/**
 * Creates fallback results when AI enrichment fails.
 * Ensures scans can complete even when OpenAI is unavailable.
 *
 * <p>This component has NO external dependencies (no Redis, no Database, no HTTP).
 * It is purely a data creator, making it easily unit testable.
 */
@Slf4j
@Component
