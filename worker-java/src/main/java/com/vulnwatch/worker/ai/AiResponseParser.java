...
/**
 * Responsible for calling OpenAI API and parsing the response.
 * Uses Spring AI's ChatClient with automatic JSON schema enforcement.
 */
@Slf4j
@Component
...
public class AiResponseParser {
    ...
    /**
     * Calls OpenAI API with the given prompt and returns structured response.
     * Spring AI automatically enforces the JSON schema from AiResponse class.
     *
    ...
    public AiResponse callOpenAi(String prompt) {
        ...
        try {
            ...
            log.debug("OpenAI response received - score: {}, findings: {}",
